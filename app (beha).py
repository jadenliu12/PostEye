...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        self.canvas1 = GradientFrame(self.frame, "#00F4FF", "#2187FF", width = 1200, height = 100, relief="sunken")
        ...
        self.btn_show = tk.Button(self.frame, text="SHOW VISION", command = lambda: self.change_cam(), width=20, height=3)
